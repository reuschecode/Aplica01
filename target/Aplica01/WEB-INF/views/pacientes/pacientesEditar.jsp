...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>SOWAD Grupo 3</title>
    <meta name="description" content="Navegacion">
    ...
    <link href="${urlPublic}css/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <link href="${urlPublic}css/global/style.bundle.css" rel="stylesheet" type="text/css" />

    <!--
    <link href="${urlPublic}vendors/general/tether/dist/css/tether.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-datetime-picker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/select2/dist/css/select2.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/nouislider/distribute/nouislider.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/owl.carousel/dist/assets/owl.carousel.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/owl.carousel/dist/assets/owl.theme.default.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/summernote/dist/summernote.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/animate.css/animate.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/toastr/build/toastr.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/morris.js/morris.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/general/sweetalert2/dist/sweetalert2.css" rel="stylesheet" type="text/css" />
    -->
    <link href="${urlPublic}vendors/custom/vendors/line-awesome/css/line-awesome.css" rel="stylesheet" type="text/css" />
    <link href="${urlPublic}vendors/custom/vendors/flaticon2/flaticon.css" rel="stylesheet" type="text/css"/>
    <link href="${urlPublic}vendors/general/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css"/>
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="${urlRoot}home">
            <img alt="Logo" src="${urlPublic}images/logo-6-sm.png" />
        </a>
    </div>
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="demo6/index.html" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-protection"></i><span class="kt-menu__link-text">Dashboard</span></a></li>
            ...
            <div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
                ...
                <div class="kt-header__brand kt-grid__item  " id="kt_header_brand">
                    <div class="kt-header__brand-logo">
                        <a href="${urlRoot}home">
                            <img alt="Logo" src="${urlPublic}images/logo-6.png" />
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a href="demo6/index.html" class="kt-menu__link "><span class="kt-menu__link-text">Inicio</span></a></li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Tablas</span><i class="kt-menu__hor-arrow la la-angle-down"></i><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="${urlRoot}pacientes" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Pacientes</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="${urlRoot}usuarios" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Usuarios</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Reportes</span><i class="kt-menu__hor-arrow la la-angle-down"></i><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
            ...
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                <div class="kt-subheader-search ">
                    <div class="kt-container  kt-container--fluid ">
                        <h3 class="kt-subheader-search__title">
                            Reporte de los recientes casos clinicos
                            <span class="kt-subheader-search__desc">Solo casos clinicos</span>
                        </h3>
                        <form class="kt-form">
                            <div class="kt-grid kt-grid--desktop kt-grid--ver-desktop">
                                    ...
                                    <div class="row kt-margin-r-10">
                                        <div class="col-lg-6">
                                            <div class="kt-input-icon kt-input-icon--pill kt-input-icon--right">
                                                <input type="text" class="form-control form-control-pill" placeholder="Codigo del caso">
                                                <span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i class="la la-puzzle-piece"></i></span></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="kt-input-icon kt-input-icon--pill kt-input-icon--right">
                                                <input type="text" class="form-control form-control-pill" placeholder="Desde">
                                                <span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i class="la la-calendar-check-o"></i></span></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="kt-input-icon kt-input-icon--pill kt-input-icon--right">
                                                <input type="text" class="form-control form-control-pill" placeholder="Hasta">
                                                <span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i class="la la-calendar-check-o"></i></span></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="kt-grid__item kt-grid__item--middle">
                                    ...
                                    <button type="button" class="btn btn-pill btn-upper btn-bold btn-font-sm kt-subheader-search__submit-btn">Buscar casos</button>
                                    <a href="#" class="kt-subheader-search__link kt-link">Busqueda avanzada</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form:form class="kt-form" modelAttribute="pacienteEditado" action="pacientes/editarPaciente" novalidate="novalidate" method="post">
                            <div class="form-group">
                                <label id="dni">DNI</label>
                                <form:input path="dni" type="number" name="dni" id="dni" class="form-control" value="${paciente.dni}" placeholder="Ingrese DNI..."/>
                            </div>
                            <div class="form-group">
                                <label for="apellidos">Apellidos</label>
                                <form:input path="apellidos" type="text" name="apellidos" id="apellidos" class="form-control" value="${paciente.apellidos}" placeholder="Escriba apellidos..."/>
                            </div>
                            <div class="form-group">
                                <label for="nombres">Nombres</label>
                                <form:input path="nombres" type="text" name="nombres" id="nombres" class="form-control" value="${paciente.nombres}" placeholder="Escriba nombres..."/>
                            </div>
                            <div class="form-group">
                                <label for="edad">Edad</label>
                                <form:input path="edad" type="number" name="edad" id="edad" class="form-control" value="${paciente.edad}" placeholder="Ingrese edad..."/>
                            </div>
                            <div class="form-group">
                                <label for="sexo">Sexo</label>
                                <form:select path="sexo" id="sexo" name="sexo" class="form-select" value="${paciente.sexo}">
                            ...
                            <div class="form-group">
                                ...
                                <form:input path="estadoCivil" type="text" name="estadoCivil" id="estadoCivil" class="form-control" value="${paciente.estadoCivil}" placeholder="Ingrese estado civil..."/>
                            </div>
                            <div class="form-group">
                                <label for="peso">Peso</label>
                                <form:input path="peso" type="number" step="any" name="peso" id="peso" class="form-control" value="${paciente.peso}" placeholder="Ingrese el peso..."/>
                            </div>
                            <div class="form-group">
                                <label for="talla">Talla</label>
                                <form:input path="talla" type="number" step="any" name="talla" id="talla" class="form-control" value="${paciente.talla}" placeholder="Ingrese la talla..."/>
                            </div>
                            <div class="form-group">
                                <label for="direccion">Direccion</label>
                                <form:input path="direccion" type="text" name="direccion" id="direccion" class="form-control" value="${paciente.direccion}" placeholder="Direccion de residencia..."/>
                            </div>
                            <div class="form-group">
                                <label for="fechaNacimiento">Fecha Nacimiento</label>
                                <form:input path="fechaNacimiento" type="date" name="fechaNacimiento" id="fechaNacimiento" value="${paciente.fechaNacimiento}" class="form-control" placeholder="Fecha nacimiento..."/>
                            </div>
                            <div class="form-group">
...
<!--begin:: Global Mandatory Vendors -->
<script src="${urlPublic}vendors/general/jquery/dist/jquery.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/popper.js/dist/umd/popper.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/js-cookie/src/js.cookie.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/moment/min/moment.min.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/tooltip.js/dist/umd/tooltip.min.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/perfect-scrollbar/dist/perfect-scrollbar.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/sticky-js/dist/sticky.min.js" type="text/javascript"></script>
<script src="${urlPublic}vendors/general/wnumb/wNumb.js" type="text/javascript"></script>
...
<script src=".${urlPublic}js/scripts.bundle.js" type="text/javascript"></script>
...
<script src="${urlPublic}js/pages/dashboard.js" type="text/javascript"></script>
