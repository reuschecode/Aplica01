            ...
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    ...
                    <div class="float-left">
                        <a href="${urlRoot}pacientes/agregar" type="submit" class="btn btn-primary" >Ingresar nuevo paciente</a>
                    </div>
                    <div class="card-body">
                            ...
                            <c:forEach items="${Vpacientes}" var="p">
                                <tr>
                                    ...
                                    Ver detalle
                                        ...
                                        <a href="${urlRoot}pacientes/detalle?dni=${p.dni}&fecha=${fechaBusqueda}" class="btn btn btn-primary" role="button">
                                            Ver datos
                                        </a>
                                    </td>
