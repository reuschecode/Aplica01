            ...
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <div class="align-right align-bottom">
                        <a class="btn btn-danger" href="${urlRoot}pacientes/editar?dni=${paciente.dni}" role="button">Editar Paciente</a>
                        <a class="btn btn-info" href="${urlRoot}pacientes/eliminarPaciente?dni=${paciente.dni}" role="button">Eliminar Paciente</a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <table class="table mb-none">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${paciente.sexo}">Hombre</c:when>
                                            <c:otherwise>Mujer</c:otherwise>
                                        </c:choose>
                                    </td>
                                    <th>Direccion</th>
                                    <td colspan="4">${paciente.direccion}</td>
                                </tr>
                                <tr>
                                    <th>Estado Civil</th>
