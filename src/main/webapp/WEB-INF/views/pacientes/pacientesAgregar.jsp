            ...
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div class="row kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form:form class="kt-form" modelAttribute="paciente" action="pacientes/agregarPaciente" novalidate="novalidate" method="post">
                        <div class="form-group">
                            <label id="dni">DNI</label>
                            <form:input path="dni" type="number" name="dni" id="dni" class="form-control" placeholder="Ingrese DNI..."/>
                        </div>
                        <div class="form-group">
                            <label for="apellidos">Apellidos</label>
                            <form:input path="apellidos" type="text" name="apellidos" id="apellidos" class="form-control" placeholder="Escriba apellidos..."/>
                        </div>
                        <div class="form-group">
                            <label for="nombres">Nombres</label>
                            <form:input path="nombres" type="text" name="nombres" id="nombres" class="form-control" placeholder="Escriba nombres..."/>
                        </div>
                        <div class="form-group">
                            <label for="edad">Edad</label>
                            <form:input path="edad" type="number" name="edad" id="edad" class="form-control" placeholder="Ingrese edad..."/>
                        </div>
                        <div class="form-group">
                            <label for="sexo">Sexo</label>
                            <form:select path="sexo" id="sexo" name="sexo" class="form-select">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="estadoCivil" type="text" name="estadoCivil" id="estadoCivil" class="form-control" placeholder="Ingrese estado civil..."/>
                        </div>
                        <div class="form-group">
                            <label for="peso">Peso</label>
                            <form:input path="peso" type="number" step="any" name="peso" id="peso" class="form-control" placeholder="Ingrese el peso..."/>
                        </div>
                        <div class="form-group">
                            <label for="talla">Talla</label>
                            <form:input path="talla" type="number" step="any" name="talla" id="talla" class="form-control" placeholder="Ingrese la talla..."/>
                        </div>
                        <div class="form-group">
                            <label for="direccion">Direccion</label>
                            <form:input path="direccion" type="text" name="direccion" id="direccion" class="form-control" placeholder="Direccion de residencia..."/>
                        </div>
                        <div class="form-group">
                            <label for="fechaNacimiento">Fecha Nacimiento</label>
                            <form:input path="fechaNacimiento" type="date" name="fechaNacimiento" id="fechaNacimiento" class="form-control"/>
                        </div>
                        <div class="form-group">
